...
import { CustomTablePagination, TTableDisplayType } from "@/components/Table/TablePagination";
import {
...
const columns: columnInput[] = [
  ...
  { id: "beforeBenchmark", label: "BeforeBenchmark", minWidth: 100, DisplayType: "Switch" },
  { id: "inSoftware", label: "InSoftware", minWidth: 100, DisplayType: "Switch" },
  {
...
const BenchmarkSetupTabPanelMethod = ({
  ...
  return (
    <>
      ...
      <Grid item xs={12} md={4}>
        <CheckBoxAutocomplete label="Method Type" placeholder="voltage" />
      </Grid>
      {/* <Grid item xs={12} md={4}>
        <CheckBoxAutocomplete label="Voltage Type" placeholder="voltage" />
      </Grid> */}
