/*
  ...
  - Added the required column `benchmarkInformationId` to the `BenchmarkInput` table without a default value. This is not possible if the table is not empty.
  - Added the required column `beforeBenchmark` to the `BenchmarkMethod` table without a default value. This is not possible if the table is not empty.
  - Added the required column `benchmarkInformationId` to the `BenchmarkMethod` table without a default value. This is not possible if the table is not empty.
  - Added the required column `inSoftware` to the `BenchmarkMethod` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_BenchmarkMethod" ("active", "benchmarkInputId", "benchmarkMethodName", "benchmarkUnitId", "createdAt", "id", "methodType", "updatedAt") SELECT "active", "benchmarkInputId", "benchmarkMethodName", "benchmarkUnitId", "createdAt", "id", "methodType", "updatedAt" FROM "BenchmarkMethod";
